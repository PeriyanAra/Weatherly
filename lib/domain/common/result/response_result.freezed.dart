...
/// @nodoc
mixin _$ResponseResult<T, E extends Exception> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $ResponseResultCopyWith<T, E extends Exception, $Res> {
  factory $ResponseResultCopyWith(ResponseResult<T, E> value,
          $Res Function(ResponseResult<T, E>) then) =
      _$ResponseResultCopyWithImpl<T, E, $Res, ResponseResult<T, E>>;
}

/// @nodoc
class _$ResponseResultCopyWithImpl<T, E extends Exception, $Res,
        $Val extends ResponseResult<T, E>>
    implements $ResponseResultCopyWith<T, E, $Res> {
...
class __$$SuccessImplCopyWithImpl<T, E extends Exception, $Res>
    extends _$ResponseResultCopyWithImpl<T, E, $Res, _$SuccessImpl<T, E>>
...
abstract class _Success<T, E extends Exception> extends ResponseResult<T, E> {
...
class __$$FailureImplCopyWithImpl<T, E extends Exception, $Res>
    extends _$ResponseResultCopyWithImpl<T, E, $Res, _$FailureImpl<T, E>>
...
class _$FailureImpl<T, E extends Exception> extends _Failure<T, E> {
  ...
  @override
  String toString() {
    return 'ResponseResult<$T, $E>.failure(error: $error)';
  }
...
abstract class _Failure<T, E extends Exception> extends ResponseResult<T, E> {
