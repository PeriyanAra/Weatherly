...
class ChopperLoggingInterceptor implements Interceptor {
  ...
  factory ChopperLoggingInterceptor(BaseLogger logger) => ChopperLoggingInterceptor._(logger);
  ...
  factory ChopperLoggingInterceptor.all(BaseLogger logger) => ChopperLoggingInterceptor._(
        logger,
        showBody: true,
        showHeader: true,
      );

  factory ChopperLoggingInterceptor.body(BaseLogger logger) => ChopperLoggingInterceptor._(
        logger,
        showBody: true,
      );

  factory ChopperLoggingInterceptor.header(BaseLogger logger) => ChopperLoggingInterceptor._(
        logger,
        showHeader: true,
      );
