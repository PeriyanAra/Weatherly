...
import 'package:weatherly/data/database/initial_scripts.dart';
import 'package:weatherly/data/database/migrations_scripts.dart';
...
abstract class DatabaseCreator {
  static Future<Database> initDatabase() async {
    ...
    log('weatherlyDbPath --- $bitsgapDbPath');
