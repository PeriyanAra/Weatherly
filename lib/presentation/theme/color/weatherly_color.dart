...
@immutable
class WeatherlyColor extends Color implements WidgetStateProperty<Color> {
  const WeatherlyColor(
    super.value, {
    Color? light,
    Color? dark,
    Color? hover,
...
extension WeatherlyColorExtensions on WeatherlyColor {
  WeatherlyColor lerp(WeatherlyColor? other, double t) {
    return WeatherlyColor(
